        ...
        <header>
          ...
          <div className="hr">
            ...
            {connected && <>
              ...
              <a href="/whatsapp" style={{background:'#25d366',color:'white',border:'none',padding:'5px 12px',borderRadius:'20px',fontSize:'11px',cursor:'pointer',textDecoration:'none',fontWeight:600}}>📱 WhatsApp</a>
